...
# plot stacked plot
def plotStackVP(concList1, concList2, hyList1, hyList2, title1, title2, spc, area, savePath=saveLoc):
    fig = plt.figure(figsize=(6,8))
...
def plotOne(params=paramsBase, savePath = saveLoc):
    ...
    print('The ni and nj are: [{}, {}]'.format(ni, nj))
...
def plotTwo(paramsBase=paramsBase, paramsAlt=paramsAlt, savePath = saveLoc):
    ...
    print('The ni and nj are: [{},{}]'.format(ni1,nj1))
