...
class Plume(object):
    ...
    **Methods**
    ...
    def get_model(self, fst_dir, ctrl_dir=None, var='AF', threshold=4.0):
        ...
        self.Model = _ModelPlume(plm=self, fst_dir=fst_dir, ctrl_dir=ctrl_dir, var=var, threshold=threshold)
        return
...
class _ModelPlume(object):
    ...
    **Methods**
    ...
    def __init__(self, plm, fst_dir, ctrl_dir=None, var='AF', threshold=4.0):
        ...
        def data_from_key(key, file_id):
            ...
            print('xypos: {}'.format(xypos))
            print('val at: {}'.format(val))
        ...
        for progress_ind, after_key in enumerate(sorted_keylist):
            ...
            for ind, val in enumerate(cur_val):
                ...
                if (val > before_val[ind] and val > after_val[ind]) and (val >= threshold and val >= self.value[ind]):
                    ...
                    try:
                        print('Getting GZ, IP1: {}'.format(cur_meta['ip1']))
