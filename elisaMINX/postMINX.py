...
# Last Edit:  2018-03-08 17:22:04
# Contact:    Nolan.Dickson@Canada.ca

# NOTE: This version has elisa modifications 
...
class Plume(object):
    ...
    **Methods**
    ...
    def get_model(self, fst_dir, ctrl_dir=None, var='AF', threshold=4.0):
        ...
        self.Model = _ModelPlume(plm=self, fst_dir=fst_dir, ctrl_dir=ctrl_dir, var=var, threshold=threshold, startTime = 12)
        return
...
class _ModelPlume(object):
    ...
    **Methods**
    ...
    def __init__(self, plm, fst_dir, ctrl_dir=None, var='AF', threshold=4.0, startTime = 12):
        ...
        # to remove human emissions PM2.5 values from the equation
        # --------------------------------------------------------------------------
